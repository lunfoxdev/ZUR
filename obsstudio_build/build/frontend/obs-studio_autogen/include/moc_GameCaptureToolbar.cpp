/****************************************************************************
** Meta object code from reading C++ file 'GameCaptureToolbar.hpp'
**
...
#include "../../../../frontend/components/GameCaptureToolbar.hpp"
...
#error "The header file 'GameCaptureToolbar.hpp' doesn't include <QObject>."
...
namespace {
struct qt_meta_tag_ZN18GameCaptureToolbarE_t {};
} // unnamed namespace

template <> constexpr inline auto GameCaptureToolbar::qt_create_metaobjectdata<qt_meta_tag_ZN18GameCaptureToolbarE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        // Slot 'on_mode_currentIndexChanged'
        QtMocHelpers::SlotData<void(int)>(1, 2, QMC::AccessPublic, QMetaType::Void, {{
            { QMetaType::Int, 3 },
        }}),
        // Slot 'on_window_currentIndexChanged'
    ...
    return QtMocHelpers::metaObjectData<GameCaptureToolbar, qt_meta_tag_ZN18GameCaptureToolbarE_t>(QMC::MetaObjectFlag{}, qt_stringData,
...
Q_CONSTINIT const QMetaObject GameCaptureToolbar::staticMetaObject = { {
    ...
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN18GameCaptureToolbarE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN18GameCaptureToolbarE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN18GameCaptureToolbarE_t>.metaTypes,
    nullptr
} };
...
void *GameCaptureToolbar::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN18GameCaptureToolbarE_t>.strings))
