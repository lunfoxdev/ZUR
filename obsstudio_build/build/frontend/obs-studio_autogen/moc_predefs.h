...
#define DL_OPENGL "libobs-opengl.so.30"
...
#define SAFE_MODULES "decklink|image-source|linux-alsa|linux-capture|linux-jack|linux-pipewire|linux-v4l2|obs-ffmpeg|obs-filters|obs-nvenc|obs-outputs|obs-qsv11|obs-transitions|obs-vst|obs-x264|rtmp-services|text-freetype2|decklink-captions|decklink-output-ui|obslua|obspython|frontend-tools"
